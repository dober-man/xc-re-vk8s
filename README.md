...
This guide is designed to progress through the setup in that order. Start with the RE deployment (re-vk8s.md) and then build on your knowledge from there. 
